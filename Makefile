...
#AVRDUDE_FLAGS = -p $(MCU) -B 1 -c $(AVRDUDE_PROGRAMMER)
...
#ELFSIZE = $(SIZE) -A $(TARGET).elf #Original line
#The following line is a trick that shows a percentage of how much flash and data space is used by your program. Very handy
